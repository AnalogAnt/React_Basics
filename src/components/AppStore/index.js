...
class AppStore extends Component {
  state = {currentTabId: 'SOCIAL', searchInput: ''}
  ...
  render() {
    ...
    const filteredApps = appsList.filter(each => each.category === currentTabId)
          ...
          <ul className="tabscon">
            {tabsList.map(each => (
              <TabItem
                ...
                key={each.tabId}
                isActive={each.tabId === currentTabId}
